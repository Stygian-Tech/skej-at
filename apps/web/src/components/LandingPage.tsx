...
const steps = [
  {
    title: "Connect",
    text: "Sign in with your Bluesky handle so Skej can prepare posts for the account you choose.",
    icon: Cloud,
  },
  {
    title: "Compose",
  ...
  {
    title: "Schedule",
    text: "Pick a time and Skej publishes automatically when your post is due.",
    icon: CalendarClock,
  },
];
  ...
  return (
    <main className="min-h-dvh overflow-hidden px-4 pb-16 pt-4 text-foreground sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-12">
        ...
        <section className="grid min-h-[calc(100dvh-12rem)] items-center gap-8 lg:grid-cols-[0.78fr_1.22fr]">
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-4">
              ...
              <p className="max-w-xl text-lg font-semibold leading-8 text-muted-foreground sm:text-xl">
                A friendly scheduler for Bluesky posts. Compose when an idea hits,
                choose a time, and let Skej publish it for you.
              </p>
            </div>
            <div className="max-w-xl rounded-[1.75rem] border border-border bg-card/85 p-3 shadow-[0_16px_40px_rgba(35,31,32,0.08)]">
              <OAuthLoginForm />
            </div>
          ...
          <div className="relative">
            <Image
              ...
              className="h-auto w-full rounded-[2rem] border border-border bg-card shadow-[0_18px_52px_rgba(35,31,32,0.12)]"
              height={1024}
              priority
        ...
        <section className="grid gap-5 rounded-[2rem] border border-border bg-card/80 p-5 shadow-[0_16px_40px_rgba(35,31,32,0.08)] lg:grid-cols-[1fr_auto] lg:items-center">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-sm font-black text-muted-foreground">
              <CalendarClock />
              Work in progress
            </div>
            <h2 className="text-3xl font-black">Useful now, intentionally focused.</h2>
            <p className="max-w-2xl text-sm font-semibold leading-6 text-muted-foreground">
              Skej is in alpha, so features and workflows may change quickly and
              sometimes drastically. Schedule individual posts, threads, replies,
              quotes, image drafts, and link cards while the product keeps improving.
            </p>
          </div>
